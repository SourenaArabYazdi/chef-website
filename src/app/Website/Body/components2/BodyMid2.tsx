...
export default function BodyMid2Component(){
    ...
    return(
        <div id="recipe" className="h-[1122.41px] bg-[#000000] text-[#FFFFFF] mt-240 sm:mt-0 md:mt-0 lg:mt-0 felx items-center justify-center sm:h-[1307.94px] sm:space-y-7 lg:h-[950.641px] lg:flex lg:flex-row lg:scroll-mt-[144px] scroll-mt-24 ">
